...
var Register = function () {
    ...
    var _d = react_1.useState(Number), httpStatusCode = _d[0], setHttpStatusCode = _d[1];
    var submit = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                    return [4 /*yield*/, fetch('http://localhost:8000/api', {
                            method: "PUT",
                        ...
                        }).then(function (resp) { return setHttpStatusCode(resp.status); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    if (httpStatusCode === 409) {
        rt = (React.createElement("label", { style: { color: "red" } }, "*Email already exists"));
    }
    ...
    return (React.createElement("form", { onSubmit: submit },
        ...
        React.createElement("input", { type: "text", className: "form-control", placeholder: "Name", required: true, onChange: function (e) { return setName(e.target.value); } }),
        ...
        React.createElement("button", { className: "w-100 btn btn-lg btn-primary", type: "submit" }, "Submit")));
};
